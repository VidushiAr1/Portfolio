...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
        .sendForm('service_far3vbp', 'template_l72tete', formRef.current, {
        publicKey: 'ehddHTCp8iaIOAHE2',
        })
        .then(
        () => {
            setSuccess(true);
  ...
  return (
    ...
    >
      ...
      <div className="formContainer">
        ...
        >
          <svg width="450px" height="450px" viewBox="0 0 32.666 32.666" className="svgSize">
            <motion.path
              strokeWidth={0.3}
              fill="none"
